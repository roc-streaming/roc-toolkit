...
int main(int argc, char** argv) {
    ...
    if (args.frame_length_given) {
        ...
        if (sender_config.input_sample_spec.ns_to_size(sender_config.internal_frame_length)
            <= 0) {
    ...
    io_config.sample_spec.setChannels(sender_config.input_sample_spec.getChannels());
    ...
    sender_config.input_sample_spec.setSampleRate(input_source->sample_rate());
