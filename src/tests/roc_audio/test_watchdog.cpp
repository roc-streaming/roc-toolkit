...
TEST(watchdog, silence_timeout_empty_frames) {
    Watchdog watchdog(test_reader, NumCh, SilenceTimeout, DropsTimeout, DropsWindow);
...
TEST(watchdog, silence_timeout_empty_frames_and_non_empty_frames) {
...
TEST(watchdog, packet_drops_frame_overlaps_with_drop_window) {
    {
        Watchdog watchdog(test_reader, NumCh, SilenceTimeout, DropsTimeout, DropsWindow);
...
TEST(watchdog, frame_flags_full_packet_drops) {
    ...
    check_n_reads(watchdog, true, DropsWindow, DropWindowsPerTimeout,
...
TEST(watchdog, disable_silence_timeout) {
    {
        Watchdog watchdog(test_reader, NumCh, SilenceTimeout, DropsTimeout, DropsWindow);
...
TEST(watchdog, disable_drops_timeout) {
    {
        Watchdog watchdog(test_reader, NumCh, SilenceTimeout, DropsTimeout, DropsWindow);

        for (packet::timestamp_t n = 0; n < DropsTimeout / SamplesPerFrame; n++) {
            CHECK(watchdog.update(n * SamplesPerFrame));
            check_read(watchdog, true, SamplesPerFrame, Frame::FlagPacketDrops);
        }
