...
ROC_NODISCARD status::StatusCode sndfile_detect_format(const SF_INFO& file_info,
                                                       audio::SampleSpec& sample_spec);
