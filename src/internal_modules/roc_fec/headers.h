...
//!   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
//! @endcode
ROC_PACKED_BEGIN class LDPC_Source_PayloadID {
private:
    //! Source block number.
    uint16_t sbn_;
...
//!   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
//! @endcode
ROC_PACKED_BEGIN class LDPC_Repair_PayloadID {
private:
    //! Source block number.
    uint16_t sbn_;
...
//!   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
//! @endcode
ROC_PACKED_BEGIN class RS8M_PayloadID {
private:
    //! Source block number.
    uint8_t sbn_[3];
